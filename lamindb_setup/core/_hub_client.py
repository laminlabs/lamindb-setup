...
# Deprecations don't affect us because we upper bound the version of supabase to 2.24.0.
for module_pattern in ("supabase", "supabase_functions", "postgrest"):
    ...
    **kwargs,
    ...
    for renew_token, fallback_env in [(False, False), (True, False), (False, True)]:
        ...
        try:
            ...
            # the last iteration reraises this further anyway
            if renew_token:
                raise
