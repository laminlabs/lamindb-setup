...
def install(session: nox.Session, group: str) -> None:
    no_deps_packages = "git+https://github.com/laminlabs/lnschema-core@lazyreload git+https://github.com/laminlabs/wetlab@lazyreload git+https://github.com/laminlabs/lamin-cli"
    schema_deps = f"""uv pip install --system git+https://github.com/laminlabs/bionty@lazyconnect git+https://github.com/laminlabs/lamindb@main
